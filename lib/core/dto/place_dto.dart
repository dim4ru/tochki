class PlaceDTO {
  ...
  @override
  String toString() =>
      'PlaceDTO(id: $id, name: $name, description: $description, latitude: $latitude, longitude: $longitude, rating: $rating, visitor_count $visitorCount, reviews_count $reviewsCount, createdAt: $createdAt, authorName: $authorName)';
}
